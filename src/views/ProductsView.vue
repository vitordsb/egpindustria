<template>
    <section class="portifolio">
          <div class="titulo">
              ...
              <h1>{{ $t('laucher') }} EGP <span>2024</span></h1>
          </div>
          
        <div id="container-produtos-evp"ref="produtosContainer">

            <Produtos title="EGP Plug IN WI-FI" img="/images/products/12Vimagem.png" specific="/pluginView"/>

            <Produtos title="EGP GUARD ON" img="/images/products/12Vimagem.png" specific="/guardon"/>

            <Produtos title="Módulo WI-FI" img="/images/products/Modulo Wifi.png" specific="/public/images/products/12nobreak.pdf"/>

            <Produtos title="Sirene Strobo" img="/images/products/SireneStrobo.png" specific="/public/images/products/12nobreak.pdf"/>

            <Produtos title="Controle Copiador" img="/images/products/Controle 4b copiador.png" specific="/public/images/products/12nobreak.pdf"/>

            <Produtos title="Controle 4 Botões" img="/images/products/CONTROLE_4B.png" specific="/public/images/products/12nobreak.pdf"/>
        ...
        <div id="container-produtos-view">
            ...
            <Produtos title="Haste Quadrada" img="/images/products/hastes.png" specific="/public/images/products/12nobreak.pdf"/>

            <Produtos title="EGP GUARD ON" img="/images/products/12nobreak.png" specific="/public/images/products/12nobreak.pdf"/>
